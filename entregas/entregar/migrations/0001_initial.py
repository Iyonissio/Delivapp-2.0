# Generated by Django 3.0.7 on 2020-07-13 09:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Levar', 'Levar'), ('Entregar ; Delivery', 'Entregar ; Delivery ')], max_length=200, null=True)),
                ('description', models.CharField(blank=True, max_length=200, null=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='')),
                ('tags', models.ManyToManyField(to='entregar.Tag')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
